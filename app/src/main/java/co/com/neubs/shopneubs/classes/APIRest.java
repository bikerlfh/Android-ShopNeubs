...
public class APIRest {
    ...
    // URL para registrar el dispositivo
    public final static String URL_FCM = "devices/";
    // URL para registrar el dispositivo con usuario authenticado
    public final static String URL_FCM_AUTH = "devices-auth/";
