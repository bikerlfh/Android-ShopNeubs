...
public class LoginRegisterActivity extends AppCompatActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
         ...
         * number.
         */
        public static PlaceholderFragment newInstance(int idLayoutFragment) {
            PlaceholderFragment fragment = new PlaceholderFragment();
            Bundle args = new Bundle();
            args.putInt(ARG_ID_LAYOUT_FRAGMENT, idLayoutFragment);
        ...
        public void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            if (getArguments() != null) {
                idLayoutFragment = getArguments().getInt(ARG_ID_LAYOUT_FRAGMENT);
            }
        }
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(idLayoutFragment, container, false);
